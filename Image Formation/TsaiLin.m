...
% ps - pixel size, mm
% Note: the correspondence of xi and s columns is needed.


function [fini,skini,tini,qini]=TsaiLin(xi,s, pxsxini,pxsyini,x0ini)

% Convert to normalized and unscaled image coordinates
...
% class available at the MATLAB File Exhange site)
