...
scatter3([As1(1),c1(1),c2(1),As2(1)],[As1(2),c1(2),c2(2),As2(2)],[As1(3),c1(3),c2(3),As2(3)])
hold on

vecsc=10   % Scale
lw=3    % LineWidth
quiver3(oi1(1),oi1(2),oi1(3),es11(1),es11(2),es11(3),vecsc,'LineWidth',lw,'color','blue')
quiver3(oi1(1),oi1(2),oi1(3),es12(1),es12(2),es12(3),vecsc,'LineWidth',lw,'color','red')
quiver3(oi1(1),oi1(2),oi1(3),es13(1),es13(2),es13(3),vecsc,'LineWidth',lw,'color','black')

quiver3(oi2(1),oi2(2),oi2(3),es23(1),es23(2),es23(3),vecsc,'LineWidth',lw,'color','black')
quiver3(oi2(1),oi2(2),oi2(3),es22(1),es22(2),es22(3),vecsc,'LineWidth',lw,'color','red')
quiver3(oi2(1),oi2(2),oi2(3),es21(1),es21(2),es21(3),vecsc,'LineWidth',lw,'color','blue')
