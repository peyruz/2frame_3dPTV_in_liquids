...
%               residing in air)
% LensType -    <string>, Specifies the lens type. Valid options: 'Entc'
%               entrocentric, 'Telc' - telecentric.
% 
% Output:
...
% 
% ver 6, Jan, 2018
% - Corrected bug in calculation of incident rays with no refracting
% interface present
% - additional input of Lens Type (Entocentric, Telecentric)

function [xi1,xi2]=Image_Formation_ver6(c1, c2, fv1, fv2, od1,od2, Rs1, Rs2,Rv1,Rv2, es13,es23, ev13, ev23, s,oi1,oi2,RInt,n,LensType)
